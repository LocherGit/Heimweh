    ...
    class PositionViewer(object):
        ...
        def viewer(self):
            ...
            for layer in config.layers:
                # if layer not in ["screens", "transient", 'overlay', "debug"]:
