...
init -1 python hide:
    ...
    config.window_title = u"Heimweh Visual Novel ver.3.3a [Mr. Ton]"
    ...
    theme.tv(
        ...
        mm_root = "images/used bg/title.jpg",

        ## The background of the game menu -Escape while playing- . This can be a color
        ## beginning with '#', or an image filename. The latter
        ## should take up the full height and width of the screen.
        gm_root = "#393939",
    ...
    style.nvl_dialogue.font = "GlacialIndifference-Regular.otf"
    ...
    style.nvl_window.background = Frame("images/gui/nvl_frame.png", 0, 0)  
    ...
    style.nvl_window.top_margin = 10
    style.nvl_window.bottom_margin = 10
    ...
    style.nvl_window.top_padding = 40
    style.nvl_window.bottom_padding = 40
    style.nvl_window.left_padding = 40
    style.nvl_window.right_padding = 40
    
    ## Interblock spacing: ------------------
    # The space between Blocks of paragraphs. 

    style.nvl_vbox.box_spacing = 5
    
    
    #####################################
    ## Text Formatting

    style.say_window.left_padding = 0.05
    style.say_window.right_padding = 0.05
    ...
    style.default.font = "GlacialIndifference-Regular.otf"
    ...
    style.mm_button[u"Start Game"].activate_sound = "audio/sfx/game_start.mp3"
    ...
    config.main_menu_music = "audio/bgm/01 - Main Menu.mp3"
    ...
    config.help = "Quickguide Heimweh.pdf"
...
python early:
    config.save_directory = "Heimweh VN-1458070556"
...
init -1 python hide:
    ...
    config.window_icon = "images/etc/icon.png"

##############################################################################
# Menu Statement Alteration
#
# Code for customizing the in-game menu choices
# http://fuckyeahrenpy.tumblr.com/post/97167953020/how-to-customize-in-game-choices
    ...
    style.menu_choice.hover_color = "#f00"
...
init python:
    ...
    build.directory_name = "Heimweh_VN-3.3a"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Heimweh_VN"
